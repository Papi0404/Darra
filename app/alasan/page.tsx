    ...
    >
      ...
      >
        ...
        <p style={{ fontFamily: 'Caveat, cursive', fontSize: '17px', color: '#7a6155', marginTop: '6px', opacity: 0.7 }}>
          klik tiap kartu buat lihat alasannya 💗
        </p>
        ...
        {reasons.map((r, i) => {
          ...
          return (
            <motion.div
              ...
              style={{
                ...
                background: isRevealed
                  ? 'linear-gradient(145deg, #fffbf5, #fde8ef)'
                  : 'linear-gradient(135deg, #e75480, #f9a8c9)',
            ...
            >
              {/* Number label */}
              <div
                className="absolute top-2 left-3 text-xs opacity-50"
                style={{ fontFamily: 'Caveat, cursive', color: isRevealed ? '#7a6155' : 'rgba(255,255,255,0.8)' }}
              >
                #{i + 1}
              </div>
              ...
              <AnimatePresence mode="wait">
                {!isRevealed ? (
                  ...
                  >
                    ...
                    <span style={{ fontFamily: 'Caveat, cursive', fontSize: '15px', color: 'white' }}>
                      klik untuk lihat
                    </span>
                  </motion.div>
                ) : (
